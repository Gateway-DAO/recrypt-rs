...
impl TransformBlock {
    ...
    fn from_bytes(bytes: &[u8]) -> Result<Self> {
        ...
        // Parse public key
        let pk1_x = &bytes[offset..offset + Monty480::ENCODED_SIZE_BYTES];
        offset += Monty480::ENCODED_SIZE_BYTES;
        let pk1_y = &bytes[offset..offset + Monty480::ENCODED_SIZE_BYTES];
        offset += Monty480::ENCODED_SIZE_BYTES;
        ...
        let pk2_x = &bytes[offset..offset + Monty480::ENCODED_SIZE_BYTES];
        offset += Monty480::ENCODED_SIZE_BYTES;
        let pk2_y = &bytes[offset..offset + Monty480::ENCODED_SIZE_BYTES];
        offset += Monty480::ENCODED_SIZE_BYTES;
    ...
    pub fn from_bytes(bytes: Vec<u8>) -> Result<Self> {
        ...
        match variant {
            0x01 => {
                ...
                // ephemeral_public_key
                let x_bytes = &bytes[offset..offset + Monty480::ENCODED_SIZE_BYTES];
                offset += Monty480::ENCODED_SIZE_BYTES;
                let y_bytes = &bytes[offset..offset + Monty480::ENCODED_SIZE_BYTES];
                offset += Monty480::ENCODED_SIZE_BYTES;
            ...
            0x02 => {
                ...
                let min_size = 1 + // variant
                    Monty480::ENCODED_SIZE_BYTES * 2 + // ephemeral public key
                ...
                let epk_x = &bytes[offset..offset + Monty480::ENCODED_SIZE_BYTES];
                offset += Monty480::ENCODED_SIZE_BYTES;
                let epk_y = &bytes[offset..offset + Monty480::ENCODED_SIZE_BYTES];
                offset += Monty480::ENCODED_SIZE_BYTES;
...
impl PublicKey {
    ...
    pub fn to_bytes(&self) -> Vec<u8> {
        let mut bytes = Vec::with_capacity(Self::ENCODED_SIZE_BYTES * 2);
